...
namespace PandaLivingWeaponMod
{
    ...
    public class Mod_PandaLivingWeaponMod : BaseUnityPlugin
    {
        ...
        private void Start()
        {
            ...
            allowAbsorbs = Config.Bind("General", "allowVital", false, "Allow life/mana/stamina score enchants spawn in selector");
            allowAbsorbs = Config.Bind("General", "allowDefence", false, "Allow DV/PV/FPV enchants spawn in selector");
