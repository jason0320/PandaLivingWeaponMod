...
public class HPWidgetThing : HPWidget
{
    public class TabThingEnchant : HPLayout<Thing>
    {
        ...
        public TabThingEnchant()
        {
            ...
            else if(allowAbsorbs)
            {
                enchantList = EClass.sources.elements.rows.Where((SourceElement.Row e) =>
                    !(e.alias.Contains("mod_")) &&
                    !(e.alias == ("living")
                    || e.alias.Contains("breathe_")
                    || e.alias.Contains("ball_")
                    || e.alias.Contains("bolt_")
                    || e.alias.Contains("hand_")
                    || e.alias.Contains("arrow_")
                    || e.alias.Contains("funnel_")
                    || e.alias.Contains("miasma_")
                    || e.alias.Contains("weapon_")
                    || e.alias.Contains("puddle_")
                    || e.alias == ("r_life")
                    || e.alias == ("r_mana")
                    || e.alias == ("r_DV")
                    || e.alias == ("r_PV")
            ...
            else if (allowInvokes && allowAbsorbs)
            {
                enchantList = EClass.sources.elements.rows.Where((SourceElement.Row e) =>
                    !(e.alias.Contains("mod_")) &&
                    !(e.alias == ("living")
