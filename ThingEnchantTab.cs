...
namespace PandaLivingWeaponMod
{
    public class ThingEnchantTab : HPLayout<Thing>
    {
        public override void OnLayout()
        {
            ...
            enchantList = enchantList.Where(e => !blacklist.Equals(e.alias)).ToArray();
            enchantList = enchantList.Where(e => !blacklist2.Contains(e.alias)).ToArray();
